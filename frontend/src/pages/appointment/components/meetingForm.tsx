...
const MeetingForm = ({
  ...
  return (
    <motion.div
      key={2}
      className={`w-full h-[100dvh] md:h-[42rem] lg:w-[41rem] shrink-0 md:p-6 md:px-4 flex flex-col`}
    ...
    >
      <Form {...form}>
        <form
          ...
          className="h-full flex flex-col min-h-0 gap-6"
        >
          <div className="space-y-4 flex-1 overflow-y-auto min-h-0 pr-1 max-md:pb-16 md:pb-2">
